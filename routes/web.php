...
use App\Http\Controllers\GoalTableController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
	...
	Route::resource('goalsTable', GoalTableController::class);
    Route::resource('goals', GoalController::class);    
    Route::resource('proposals', ProposalController::class);
    Route::get('/numero-letra/{id}',[App\Http\Controllers\LoanController::class,'addNumberLetter'])->name('addNumberLetter');
    Route::post('/letter-annexe-update',[App\Http\Controllers\LoanController::class,'updateLetterAnnexe']);
    
    //Cotizador
    Route::resource('cotizar', CotizarController::class);
    Route::get('/cotizar/detail/{id}',[App\Http\Controllers\CotizarController::class,'detail'])->name('detail');
    Route::get('/reporte-cotizacion',[App\Http\Controllers\CotizarController::class,'report'])->name('report.cotizacion');
    Route::get('/reporte-waiter',[App\Http\Controllers\CotizarController::class,'reportWaiter'])->name('report.waiter');
    Route::get('/cotizacion-confi',[App\Http\Controllers\CotizarController::class,'confi'])->name('confi');
    Route::post('/confi-update',[App\Http\Controllers\CotizarController::class,'confi_update'])->name('confi_update');
    Route::post('/checkDNI',[App\Http\Controllers\CotizarController::class,'checkDNI'])->name('checkDNI');
    Route::post('/checkRUC',[App\Http\Controllers\CotizarController::class,'checkRUC'])->name('checkRUC');
   ...
   //Prestamos----------
    ...
    Route::get('/detail/{id}',[App\Http\Controllers\LoanController::class,'detail'])->name('detail');
    Route::get('/quota/{id}',[App\Http\Controllers\QuoteController::class,'quota'])->name('quota');
    ...
    Route::get('expenese/quick-add',[ExpenseController::class,'quickAdd']);
    Route::post('expenses/save-quick-detail',[ExpenseController::class,'saveQuickDetail']);
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/loan_pdf', [App\Http\Controllers\LoanController::class, 'pdf'])->name('loan_pdf');
    Route::post('/loan_send', [App\Http\Controllers\LoanController::class, 'send'])->name('loan_send');
    Route::post('/loan_edit_quote', [App\Http\Controllers\LoanController::class, 'update'])->name('loan_edit_quote');
    Route::post('/proposal_delete', [App\Http\Controllers\ProposalController::class, 'destroy'])->name('proposal');
    Route::post('/proposal_pdf', [App\Http\Controllers\ProposalController::class, 'pdf'])->name('proposal_pdf');
    Route::post('/proposal_send', [App\Http\Controllers\ProposalController::class, 'send'])->name('proposal_send');
	Route::post('/quote_delete', [App\Http\Controllers\QuoteController::class, 'destroy'])->name('quote_delete');
    Route::post('/goal_add', [App\Http\Controllers\GoalController::class, 'store'])->name('goal_add');
    Route::post('/cotizar_pdf', [App\Http\Controllers\CotizarController::class, 'pdf'])->name('cotizar_pdf');
    Route::post('/storeAdmin', [App\Http\Controllers\CotizarController::class, 'storeAdmin']);
});
