...
class TaxonomyController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        if (request()->ajax()) {
            try {
                $input = $request->only(['name', 'description', 'keywords', 'title_seo', 'description_seo']);
                $business_id = $request->session()->get('user.business_id');
                ...
                $category->title_seo = $input['title_seo'];
                $category->description_seo = $input['description_seo'];
