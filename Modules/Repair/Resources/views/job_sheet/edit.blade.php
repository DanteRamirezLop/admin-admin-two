            ...
            <div class="box-body">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        @endphp
                        {!! Form::label('custom_field_4', $custom_field_4_label . ':') !!} <br>
                        <img alt="Firma digital del cliente"  width="200px" height="120px" src=" {{$job_sheet->custom_field_4}}" /> 
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <img alt="Firma digital del tecnico"  width="200px" height="120px" src=" {{$job_sheet->custom_field_5}}" />
                    </div>
                </div>
