...
class JobSheetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // if (! empty($input['custom_field_4'])) {
            //     $firmaData = $input['custom_field_4'];
            //     $firma = str_replace('data:image/png;base64,', '', $firmaData);
            //     $firma = str_replace(' ', '+', $firma);
            //     $firmaNombre = 'firmas/' . uniqid() . '.png';
            //     Storage::disk('public')->put($firmaNombre, base64_decode($firma));
            // }

            // if (! empty($input['custom_field_5'])) {
            //     $firmaData = $input['custom_field_5'];
            //     $firma = str_replace('data:image/png;base64,', '', $firmaData);
            //     $firma = str_replace(' ', '+', $firma);
            //     $firmaNombre = 'firmas/' . uniqid() . '.png';
            //     Storage::disk('public')->put($firmaNombre, base64_decode($firma));
    ...
    public function show($id)
    {
        ...
        //Firma del cliente
        // $data_uri = $job_sheet->custom_field_4;
        // $encoded_image = explode(",", $data_uri)[1];
        // $decoded_image = base64_decode($encoded_image);
        // $firma = file_put_contents("signature.png", $decoded_image);
