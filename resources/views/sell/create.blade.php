...
@section('javascript')
    ...
    <script type="text/javascript">
		...
		$(document).on('click', '#calculate', function(e) {
            const exchangeRate = parseFloat($('#exchange_rate_sell').val());
            ...
            $('.payment-amount').val(dolares.toFixed(2));
			calculate_balance_due();
			$('#note_0').val('Cambio de moneda: ' + amountVar + ' Soles = ' + dolares.toFixed(2) + ' Dolares al tipo de cambio de ' + exchangeRate); 
		});
            ...
            $("#search_ruc").on('click',function () {
                ...
                $.ajax({
                    ...
                    data: {
                     ...
                     success: function (response) {
                         if(response.status){
							$("#supplier_business_name").val(response.supplier_business_name);
