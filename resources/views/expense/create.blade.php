...
<section class="content">
	...
	@component('components.widget',['class'=>'box-soild','id'=>"table_payment",'title'=>__('lang_v1.detailed')])
	 @slot('tool')
            <div class="box-tools">
                <button type="button" class="btn btn-block btn-primary btn-modal" 
                data-href="{{action([\App\Http\Controllers\ExpenseController::class, 'quickAdd'])}}" 
                data-container=".expense_detail_modal">
		...
		<div class="row">
			<div class="col-sm-12">
				<input type="text" class="hide" id="number_row" value="0">
				<table class="table table-condensed table-bordered blue-header variation_value_table text-center" id="expense_payment_table">
					<thead>
						<tr>
							<th>Tipo de Gasto</th>
							<th>Fecha inicio</th>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="pull-right">
							...
							{!! Form::text('final_total', null, ['class' => 'form-control input_number disabled_input', 'placeholder' => '0.00', 'required']); !!}
						</div>
					</div>
				</div>
	...
	<div class="modal fade expense_detail_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" data-backdrop="static" data-keyboard="false"></div>
