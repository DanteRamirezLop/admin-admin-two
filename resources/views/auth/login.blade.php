...
@section('content')
    <div class="login-form col-md-12 col-xs-12 right-col-content">
		<div class="row" style="text-align: center;">
            <img height="150" src="img/comerser.png" alt="">
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" id="login-form">
            ...
            <br>
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-flat btn-login g-recaptcha"
						data-sitekey="6LemvSMnAAAAAKUCP22SjUOzCKreWSesDIOmdbms" 
                    	data-callback='onSubmit' 
                    	data-action='submit'>@lang('lang_v1.login')</button>
                @if(config('app.env') != 'demo')
