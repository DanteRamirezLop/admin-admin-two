    ...
    <div class="modal-body">
      ...
      <div class="form-group">
       {!! Form::label('keywords', 'Keywords' . ':') !!}
        {!! Form::text('keywords', $category->keywords, ['class' => 'form-control', 'placeholder' => '']); !!}
      </div>
      
      <div class="form-group">
       {!! Form::label('title_seo', 'Título seo' . ':') !!}
        {!! Form::text('title_seo', $category->title_seo, ['class' => 'form-control', 'placeholder' => '']); !!}
      </div>
      
       <div class="form-group">
        {!! Form::label('description_seo', 'Descripción seo' . ':') !!}
        {!! Form::textarea('description_seo', $category->description_seo, ['class' => 'form-control', 'placeholder' => '', 'rows' => 3]); !!}
      </div>
