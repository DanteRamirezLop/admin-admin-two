      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::text('final_total', @num_format($expense->final_total), ['class' => 'form-control input_number form-control  disabled_input', 'placeholder' => __('sale.total_amount'), 'required']); !!}
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-4">
  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        @if($expense_details)
        <table class="table table-condensed table-bordered blue-header variation_value_table text-center">
					<thead>
						<tr>
							<th>Tipo de Gasto</th>
							<th>Fecha inicio</th>
