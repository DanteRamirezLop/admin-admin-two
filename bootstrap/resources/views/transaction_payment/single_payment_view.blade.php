<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <div class="modal-title visible-print-block">
        <h4 style="margin-top: 6rem;">
        @if(!empty($single_payment_line->payment_ref_no))
          ( @lang('purchase.ref_no'): {{ $single_payment_line->payment_ref_no }} )
        @endif
        </h4>
      ...
      <button type="button" class="btn btn-primary no-print" 
        aria-label="Print" 
          onclick="$(this).closest('div.modal').printThis({
            header: `<div><img src='{{ asset('images/logo-blue.png') }}' alt='Logo libra xcmg' width='290px' height='53px' /> </div>`,
          });">
