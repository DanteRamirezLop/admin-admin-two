  ...
  <main>
      <table width="100%" class="w-full" cellpadding='2'>
          ...
          <td style="width: 65%;">
            ...
            <tr  class="text-lg">
              ...
              <tr class="text-lg">
                ...
                <td style="width: 68%;"> {{$loan->multiplier}}% </td>
              </tr>
          ...
          <td style="width: 35%;">
            ...
            <table width="100%" class="w-full" border='1' align='center' cellpadding='2' cellspacing='0'>
              ...
              <tr>
                ...
                <td align="center">$ {{number_format($default_interest,2)}}</td>
              </tr>
              <tr>
                <td align="left">Meses atrasados </td>
                <td align="center">$ {{number_format($months_behind,2) }}</td>
              </tr>
              <tr>
                <td align="left">Pago del mes</td>
                <td align="center">$ {{number_format($amount_to_pay,2)}}</td>
              </tr>
              <tr class="bg-gray-light">
                <td align="left"> <strong>Total</strong></td>
                <td align="center">$ {{number_format(( $amount_to_pay + $months_behind + $default_interest),2)}}</td>
              </tr>
            </table>
          </td>
        </tr>
       ...
       <table  width="100%" class="w-full" border='1' cellpadding='2' cellspacing='0'>
            ...
            <tr>
                ...
                <td align="center"></td>
                <td align="center">$ {{ number_format($sell->total_before_tax,2) }}</td>
            </tr>
            <tr>
                <td align="left">Descuento por capitalización</td>
                <td align="center"><b>(-)</b></td>
                <td align="center"><div><span @if( $sell->discount_type == 'fixed') data-currency_symbol="true" @endif> $ {{  number_format($sell->discount_amount,2) }}</span> @if( $sell->discount_type == 'percentage') {{ '%'}} @endif</span></div></td>
            </tr>
            ...
            @if(session('business.enable_rp') == 1 && !empty($sell->rp_redeemed) )
                ...
                <td align="center"><b>(-)</b></td>
                <td align="center">$ {{ number_format($sell->rp_redeemed_amount,2) }}</td>
                </tr>
            @endif
            <tr>
            ...
            <tr>
                ...
                <td align="center"><b>(+)</b></td>
                <td align="center">$ {{ number_format($sell->shipping_charges,2) }}</td>
            </tr>
            @if( !empty( $sell->additional_expense_value_1 )  && !empty( $sell->additional_expense_key_1 ))
                ...
                <td align="center"><b>(+)</b></td>
                <td align="center">$ {{  number_format($sell->additional_expense_value_1,2) }}</td>
                </tr>
            @endif
            @if( !empty( $sell->additional_expense_value_2 )  && !empty( $sell->additional_expense_key_2 ))
                ...
                <td align="center"><b>(+)</b></td>
                <td align="center">$ {{  number_format($sell->additional_expense_value_2,2) }}</td>
                </tr>
            @endif
            @if( !empty( $sell->additional_expense_value_3 )  && !empty( $sell->additional_expense_key_3 ))
                ...
                <td align="center"><b>(+)</b></td>
                <td align="center">$ {{ number_format($sell->additional_expense_value_3,2) }}</td>
                </tr>
            @endif
            @if( !empty( $sell->additional_expense_value_4 ) && !empty( $sell->additional_expense_key_4 ))
                ...
                <td align="center"><b>(+)</b></td>
                <td align="center">$ {{ number_format($sell->additional_expense_value_4,2) }}</td>
                </tr>
            @endif
            <tr>
                <td align="left">{{ __('sale.total_payable') }} </td>
                <td align="center"></td>
                <td align="center">$ {{ number_format($sell->final_total,2) }}</td>
            </tr>
            @if($sell->type != 'sales_order')
            <tr class="bg-gray-light">
                <th align="left">{{ __('sale.total_paid') }}:</th>
                <td align="center"></td>
                <td align="center"><span>$ {{ number_format($total_paid,2) }}</span></td>
            </tr>
            <tr class="bg-gray-light">
                <th align="left">{{ __('sale.total_remaining') }}:</th>
                <td align="center"></td>
                <td align="center">
                    <span>$ {{ number_format(($sell->final_total - $total_paid),2) }}</span>
                </td>
            </tr>
            @endif
      </table>
      ...
      <h2 class="text-center">Letras</h2>
        <table  width="100%" class="w-full" border='1' align='center' cellpadding='3' cellspacing='0'>
            ...
            <tr>
                ...
                <td align="center">$ {{number_format($paymentShedule->getQuote(),2)}}</td>
                <td align="center">
      ...
      <table  width="100%" class="w-full" border='1' align='center' cellpadding='3' cellspacing='0'>
        ...
        <tr>
          ...
          <td  align="center"> $ {{number_format($transactionPayment->amount,2)}}</td>
        </tr>
        @endforeach
      </table>
                ...
                <td style="width: 60%;">
                        <table width="100%" class="w-full" border='1' align='center' cellpadding='2' cellspacing='0'>
                                ...
                                <tr>
                                    ...
                                    <td align="center"> ${{number_format($mora->late_amount,2)}}</td>
                                    <td align="center"> {{$mora->days_late}} </td>
                                </tr>
                                @endforeach
                                <tr>
                                    <td align="left"><strong>Total</strong></td>
                                    <td  colspan="2" align="center"> ${{number_format($moras->sum('late_amount'),2)}}</td>
                                </tr>     
                            </table> 
                    </td>
                    <td style="width: 40%;"></td>
