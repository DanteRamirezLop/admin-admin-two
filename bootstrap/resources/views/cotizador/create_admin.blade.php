...
<section>
    ...
    <div class="box box-primary">
        ...
        {!! Form::open(['url' => action([\App\Http\Controllers\CotizarController::class, 'storeAdmin']), 'method' => 'post', 'id'=>'cotizar_add_form' ]) !!}
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group col-sm-12">
                        {!! Form::label('allow_decimal', 'Precio' . ':*') !!} 
            ...
            <div id="credito" class="row" style="display: none;">
                <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                    ...
                    <div class="form-group col-sm-5">
                         {!! Form::label('allow_decimal', 'Inicial en %' ) !!} 
                ...
                <div class="col-md-6">
                    <div class="row" id="inicial" style="display: none;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group col-sm-12">
                                {!! Form::label('rate_fracction', 'Tasa de inicial' . ':*') !!} 
